...
// in parcel_am/test/features/travellink/presentation/bloc/auth_bloc_session_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockKycUseCase extends _i1.Mock implements _i10.KycUseCase {
  MockKycUseCase() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i6.Future<_i3.Either<_i8.Failure, String>> getKycStatus(String? userId) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Stream<String> watchKycStatus(String? userId) =>
      (super.noSuchMethod(
