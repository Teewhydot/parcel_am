...
enum ParcelStatus {
  ...
  /// Only parcels with status 'created' can be cancelled.
  /// Once a courier accepts (status becomes 'paid'), cancellation is not allowed.
  bool get canBeCancelled => this == ParcelStatus.created;
