...
void main() {
  ...
  checks['UserEntity has kycStatus field'] = _checkFileContains(
    'lib/features/parcel_am_core/domain/entities/user_entity.dart',
  ...
  checks['UserModel handles kycStatus'] = _checkFileContains(
    'lib/features/parcel_am_core/data/models/user_model.dart',
    ['kycStatus', 'super.kycStatus']
  );
  
  // Check 3: AuthBloc has KYC integration
  checks['AuthBloc has KYC integration'] = _checkFileContains(
    'lib/features/parcel_am_core/presentation/bloc/auth/auth_bloc.dart',
  ...
  checks['AuthRemoteDataSource syncs KYC'] = _checkFileContains(
    'lib/features/parcel_am_core/data/datasources/auth_remote_data_source.dart',
    ['syncKycStatus', '_mapFirebaseUserToModelWithKyc']
  );
  
  // Check 5: KycBloc exists
  checks['KycBloc exists'] = File('lib/features/parcel_am_core/presentation/bloc/kyc/kyc_bloc.dart').existsSync();
  
  // Check 6: KycBloc has all states
  checks['KycBloc has all states'] = _checkFileContains(
    'lib/features/parcel_am_core/presentation/bloc/kyc/kyc_state.dart',
  ...
  checks['KycBloc has all events'] = _checkFileContains(
    'lib/features/parcel_am_core/presentation/bloc/kyc/kyc_event.dart',
  ...
  // Check 9: Tests exist
  checks['Tests exist'] = File('test/features/parcel_am_core/presentation/bloc/kyc_bloc_test.dart').existsSync() &&
                          File('test/features/parcel_am_core/presentation/bloc/auth_bloc_kyc_test.dart').existsSync();
